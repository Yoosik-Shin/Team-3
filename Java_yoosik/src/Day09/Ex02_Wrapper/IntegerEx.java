...
public class IntegerEx {
	...
	public static void main(String[] args) {
		...
		// (정수)	--> (문자열)
		// (정수)	--> (숫자의 다른타입)
		System.out.println( Integer.parseInt("28") + 2 );  	// 문자열->정수 : 30
		System.out.println( Integer.toString(28) + 2 );	   	// 정수->문자열 : 282
		System.out.println( 28 + "" );					   	// 정수->문자열 : 문자열28
		System.out.println( A.doubleValue() + 2.5 );		// 정수->실수 : 102.5
		System.out.println( Integer.toBinaryString(28));	// 이진수 문자열 : 11100
		System.out.println( Integer.bitCount(28) );			// 이진수 1비트 개수 : 3
