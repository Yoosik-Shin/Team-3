...
interface FuncInterface1 {
	// @FunctionalInterface 지정 시, 추상메소드가 없거나 2개 이상이면 에러발생
	void method();
}
...
public class LambdaFormat {
	...
	public static void main(String[] args) {
		...
		FuncInterface1 fi1 = () -> System.out.println("자바람다식1");
 		...
 		// (에러) FuncInterface4 fi5 = (a, b) -> return a + b; // return문만 있을 땐, {}생략불가
 		FuncInterface4 fi6 = (a, b) -> a + b;		// * 반환값만 있는 경우, return/{}동시 생략
