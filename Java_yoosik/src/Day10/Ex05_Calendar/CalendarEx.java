...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		Calendar now = Calendar.getInstance();	// 기본 현재 날짜/시간으로 객체를 가져온다 , static메소드
		...
		lastDay.set(2025, Calendar.SEPTEMBER, 16, 18, 20, 0); //연월일시분초
		...
		birth.set( 1988, Calendar.MARCH, 9 );		// 내 생일로 날짜 지정하기 : 2000/08/22
