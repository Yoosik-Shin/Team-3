...
// Number 클래스 타입 매개변수로 사용가능 하도록 제한
...
public class LimitedTypeClass {
	...
	public static void main(String[] args) {
		...
		D<C> d3 = new D<C>();
//(에러) D<X> d4 = new D<X>();
		// D 클래스 매개변수를 A 클래스로 제한하고 있기 때문에,
		// X 클래스 타입 매개변수 지정 불가
...
//		 (에러 : 숫자타입이 아님)E<Boolean> e4 = new E<Boolean>();
		 ...
		 // 그냥 쓴 정수는 (127) Byte범위안에 있든 어디있든 int타입으로 인식
		 // int는 4byte, Byte는 1byte 이기때문에 강제 형변환이 필요하다.
